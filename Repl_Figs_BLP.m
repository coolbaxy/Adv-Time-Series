% Repl_Figs_BLP.m
% -------------------------------------------------------------------------
% Bayesian Local Projection version of the plotting code used for Figures
...
% FIGURE 7 (BLP)
% =========================================================
choose_vars_fig7 = [12 7 2 3 4 5 9 10 8 11];

[data7_blp, ~, vars7, ~, ~, ~] = est_irf_blp( ...
    nirf, bound, ndraws, nconst, prior, begin_date, end_date, ...
    esty1, estq1, esty2, estq2, nlags, choose_vars_fig7, samp, DATA_MASTER, labels_vars, ...
    'identification', 'CHOL', ...
    'shockVar', 1, ...
    'shockSize', 1, ...
    'tau', 10, ...
    'seed', 1, ...          % remove/adjust if you prefer different random draws
    'scale100', true);

plot_irf_grid_like(data7_blp, vars7, ...
    'Figure 7 (Bayesian Local Projections)', fonttype, ftsizeaxis, titlefontsize);
